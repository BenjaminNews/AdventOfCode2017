...
public class DayTwo {
    ...
    //Part one
    public static int getChecksumPartOne(String input) {
        int total = 0;
    ...
    //Part two
    public static int getChecksumPartTwo(String input) {
        int total = 0;
        for(String inputLine : input.split("\n")) {
            int[] values =  Arrays.stream(inputLine.split("\\s+")).mapToInt(Integer::parseInt).sorted().toArray();
            boolean found = false;
    ...
    public static void main(String[] args) {
        System.out.printf("Part one: %d", DayTwo.getChecksumPartOne(input));
        System.out.printf("%nPart two: %d", DayTwo.getChecksumPartTwo(input));
    }

    private static final String input = "5048\t177\t5280\t5058\t4504\t3805\t5735\t220\t4362\t1809\t1521\t230\t772\t1088\t178\t1794\n" +
